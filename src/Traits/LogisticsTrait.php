...
trait LogisticsTrait
{
    ...
    {
        $finalParamArr = Common::handleParam(LogisticsParam::$logistics[__FUNCTION__], $paramArr);
    ...
    {
        $urlParamArr = Common::handleParam(LogisticsParam::$logistics[__FUNCTION__], $paramArr);
