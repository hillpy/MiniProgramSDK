...
class AnalysisConstant extends BaseConstant
{
    ...
    const GET_USER_PORTRAIT_PATH = '/datacube/getweanalysisappiduserportrait?';
    const GET_VISIT_DISTRIBUTION_PATH = '/datacube/getweanalysisappidvisitdistribution?';
    const GET_VISIT_PAGE_PATH = '/datacube/getweanalysisappidvisitpage?';
}
